...
router.get('/inCity/:cityId', auth(endPoint.get), validation(validators.getHotelsInCity),asyncHandler(hotelController.getHotelsInCity));
router.get('/inRegion/:regionId', auth(endPoint.get), validation(validators.getHotelsInRegion),asyncHandler(hotelController.getHotelsInRegion));
