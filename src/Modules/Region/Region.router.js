...
router.get('/',  validation(validators.getRegions),asyncHandler(regionController.getRegions));
router.get('/inCity/:countryId',  validation(validators.getRegionsInCity),asyncHandler(regionController.getRegionsInCity));
